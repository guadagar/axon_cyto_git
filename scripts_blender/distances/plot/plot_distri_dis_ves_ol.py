...
g = open('./dis_ves_ol/fw_stats.txt','r')
f = open('./dis_ves_ol/fh_stats.txt','r')

s = open('./dis_ves_ol/xr_stats.txt','r')
p = open('./dis_ves_ol/fp_stats.txt','r')
