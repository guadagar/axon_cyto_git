...
g = open('./std_cm/fw_std_dis.txt','r')
f = open('./std_cm/fh_std_dis.txt','r')

s = open('./std_cm/xr_std_dis.txt','r')
p = open('./std_cm/fp_std_dis.txt','r')
