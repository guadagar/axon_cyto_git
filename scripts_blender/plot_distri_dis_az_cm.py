...
g = open('./dis_cm_az/fw_az_dis_median.txt','r')
f = open('./dis_cm_az/fh_az_dis_median.txt','r')

s = open('./dis_cm_az/xr_az_dis_median.txt','r')
p = open('./dis_cm_az/fp_az_dis_median.txt','r')
