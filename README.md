...
You can find all the code used to generate the figures in the `/script_figures/` folder. The `/data/` folder contains a table with all the measurements taken from the 3D reconstructions. Additionally, in the `/scripts_blender/` folder, you will find all the scripts created for analyzing the meshes.
