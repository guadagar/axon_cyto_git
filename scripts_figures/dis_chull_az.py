...
data1 = data.loc[(data['dis_chull_az'] > 0)]
#data1['rt'] = data1['dis_cm_az']/data1['disp_cm']

axs = sns.violinplot(data=data1, x="Mito", y="dis_chull_az", hue="Condition",order=['No','Yes'],
...
#axs.set_yticklabels([])
#axs.set_xlabel('')
axs.set_ylabel(r'Dis OL AZ ($\mu$m)',fontsize=9,labelpad=0.3)
#axs.set_ylabel('')
...
plt.savefig('../../../figures/v2/figures/new/final/final_final/another_final/dis_ol_az.png',dpi =600)#,bbox_inches='tight')
...
print('L-C-NM',l_ltp_nm['dis_chull_az'].median(),l_c_nm['dis_chull_az'].median(),stats.ks_2samp(l_ltp_nm['dis_chull_az'],l_c_nm['dis_chull_az']),stats.mannwhitneyu(l_ltp_nm['dis_chull_az'], l_c_nm['dis_chull_az'])[1])
print('L-C_M',l_ltp_m['dis_chull_az'].median(),l_c_m['dis_chull_az'].median(),stats.ks_2samp(l_ltp_m['dis_chull_az'],l_c_m['dis_chull_az']),stats.mannwhitneyu(l_ltp_m['dis_chull_az'], l_c_m['dis_chull_az'])[1])
