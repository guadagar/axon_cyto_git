...
circ1 = Line2D([0], [0], linestyle="none", marker="o",  markersize=2, markerfacecolor="r",mec='r')
circ2 = Line2D([0], [0], linestyle="none", marker="o",  markersize=2, markerfacecolor="salmon",mec='salmon')

plt.savefig('/Users/guadagar/Documents/trabajo/mito_project/axon_cytoplasm/figures/new_5_2025/dis_svs_msb_ltp.png',dpi =600)
