...
data = data1.loc[(data1['dis_cm_az'] > 0)]

axs = sns.violinplot(data=data, x="Mito", y="dis_cm_az", hue="Condition",order=['No','Yes'],
...
axs.set_ylabel(r'D$\rm _{CC-AZ}$ ($\mu$m)',fontsize=9,labelpad=0.3)
plt.legend([],[], frameon=False)
axs.tick_params(axis='both', which='major', labelsize=9,pad=0.3)
axs.yaxis.offsetText.set_fontsize(9)

plt.savefig('/Users/guadagar/Documents/trabajo/mito_project/axon_cytoplasm/figures/new_5_2025/dis_cc_az.png',dpi =600)
