...
plt.scatter(ltp_m['b_vol'],ltp_m['mean_ves_vol'],color='#CB1D25',marker='.',s = 10)#, label = 'LTP')
plt.scatter(c_m['b_vol'],c_m['mean_ves_vol'],color = '#224FDF',marker='.',s = 10)#, label = 'CTRL')
...
plt.ylim(0.0005,0.3)
plt.text(0.075,0.15, yText1, fontsize=7,color='#224FDF')
plt.text(0.075,0.09, yText2, fontsize=7,color='#CB1D25')
