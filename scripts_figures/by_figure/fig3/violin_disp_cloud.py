...
'''
This script generates fig 3 panel h
GCG
'''
...
fig.subplots_adjust(right=0.99, left = 0.31, bottom =0.16, top = 0.85)
...
plt.savefig('/Users/guadagar/Documents/trabajo/mito_project/axon_cytoplasm/figures/new_5_2025/violin_disp_cloud.png',dpi =600)
