...
plt.errorbar(data['Time (min)'], data['avg%control'],yerr = data['err%control'], fmt='.', color='b',markersize=2,markeredgewidth=0.1,elinewidth=0.3,label = 'Control')
plt.errorbar(data['Time (min)'], y = data['avg%LTP'], yerr = data['err%LTP'] , fmt='.', color='r',markersize=2,markeredgewidth=0.1,elinewidth=0.3,label = 'LTP')
...
plt.savefig('/Users/guadagar/Documents/trabajo/mito_project/axon_cytoplasm/figures/new_5_2025/baselinev1.png', dpi = 600)
...
#plt.savefig('/Users/guadagar/Documents/trabajo/mito_project/axon_cytoplasm/figures/new_5_2025/waveform_ctrlv1.png', dpi = 1500)
...
#plt.savefig('/Users/guadagar/Documents/trabajo/mito_project/axon_cytoplasm/figures/new_5_2025/waveform_ltpv1.png', dpi = 1500)

fig, axs = plt.subplots(figsize=(0.4, 0.4))
fig.subplots_adjust(right=0.99, left = 0.05, bottom =0.15, top = 0.87)

plt.plot(np.arange(0,5,0.1),0.01*np.ones(len(np.arange(0,5,0.1))),'r',linewidth=0.1)
plt.plot(np.ones(len(np.arange(0,0.01,0.005))), np.arange(0,0.01,0.005),'b',linewidth=0.1)
