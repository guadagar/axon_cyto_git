...
plt.savefig('../../../figures/v2/figures/new/final/final_final/another_final/b_vol.png',dpi =600)#,bbox_inches='tight')
...
print('L-C-NM',l_ltp_nm['b_vol'].median(),l_c_nm['b_vol'].median(),stats.ks_2samp(l_ltp_nm['b_vol'],l_c_nm['b_vol']),stats.mannwhitneyu(l_ltp_nm['b_vol'], l_c_nm['b_vol'])[1])
print('L-C_M',l_ltp_m['b_vol'].median(),l_c_m['b_vol'].median(),stats.ks_2samp(l_ltp_m['b_vol'],l_c_m['b_vol']),stats.mannwhitneyu(l_ltp_m['b_vol'], l_c_m['b_vol'])[1])
