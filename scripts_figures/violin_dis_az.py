...
#axs.set_yticklabels([])
#axs.set_xlabel('')
axs.set_ylabel(r'Median Dis AZ (um)',fontsize=9,labelpad=0.3)
#axs.set_ylabel('')
...
#plt.savefig('./Figures/violin_median_dis_AZ.png',dpi =600)#,bbox_inches='tight')
...
print('L-C-NM',l_ltp_nm['final_dis_AZ'].median(),l_c_nm['final_dis_AZ'].median(),stats.ks_2samp(l_ltp_nm['final_dis_AZ'],l_c_nm['final_dis_AZ']),stats.mannwhitneyu(l_ltp_nm['final_dis_AZ'], l_c_nm['final_dis_AZ'])[1])
print('L-C_M',l_ltp_m['final_dis_AZ'].median(),l_c_m['final_dis_AZ'].median(),stats.ks_2samp(l_ltp_m['final_dis_AZ'],l_c_m['final_dis_AZ']),stats.mannwhitneyu(l_ltp_m['final_dis_AZ'], l_c_m['final_dis_AZ'])[1])
