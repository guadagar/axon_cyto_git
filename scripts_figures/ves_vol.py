...
#data1 = data.loc[(data['ske_ves_ass'] > 0)]
...
#axs.set_yticklabels([])
#axs.set_xlabel('')
axs.set_ylabel(r'Total Ves Vol ($\mu$m$^3$)',fontsize=9,labelpad=0.3)
#axs.set_ylabel('')
...
plt.savefig('../../../figures/v2/figures/new/final/final_final/another_final/ves_vol.png',dpi =600)#,bbox_inches='tight')
...
print('L-C-NM',l_ltp_nm['mean_ves_vol'].median(),l_c_nm['mean_ves_vol'].median(),stats.ks_2samp(l_ltp_nm['mean_ves_vol'],l_c_nm['mean_ves_vol']))
print('L-C_M',l_ltp_m['mean_ves_vol'].median(),l_c_m['mean_ves_vol'].median(),stats.ks_2samp(l_ltp_m['mean_ves_vol'],l_c_m['mean_ves_vol']))
