...
axs = sns.violinplot(data=data, x="Mito", y="mito_vol", hue="Condition",order=['No','Yes'],
...
plt.savefig('../../../figures/v2/figures/new/final/final_final/another_final/mito_vol.png',dpi =600)#,bbox_inches='tight')
