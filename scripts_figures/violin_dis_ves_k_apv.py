...
data = pd.read_csv('../../../latest_results/data/all_data_together/all_data_apv.csv')
...
data['dis_final'] = 1000*data['mean_dis_ves']

axs = sns.violinplot(data=data, x="b_vol", y="dis_final", hue="Condition",order=['No','Yes'],
...
print('L-C-NM',l_ltp_nm['b_sa'].median(),l_c_nm['b_sa'].median(),stats.ks_2samp(l_ltp_nm['b_sa'],l_c_nm['b_sa']))
print('L-C_M',l_ltp_m['b_sa'].median(),l_c_m['b_sa'].median(),stats.ks_2samp(l_ltp_m['b_sa'],l_c_m['b_sa']))
