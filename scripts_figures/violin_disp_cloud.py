...
#axs.set_yticklabels([])
#axs.set_xlabel('')
axs.set_ylabel(r'Standard Distance Ves Cloud ($\mu$m)',fontsize=9,labelpad=0.3)
#axs.set_ylabel('')
...
print('L-NM_M',stats.ks_2samp(l_ltp_m['disp_cm'],l_ltp_nm['disp_cm']),stats.mannwhitneyu(l_ltp_m['disp_cm'], l_ltp_nm['disp_cm'])[1])
