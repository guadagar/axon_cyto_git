...
print('L-C-NM',l_ltp_nm['b_vol'].median(),l_c_nm['b_vol'].median(),stats.ks_2samp(l_ltp_nm['b_vol'],l_c_nm['b_vol']))
print('L-C_M',l_ltp_m['b_vol'].median(),l_c_m['b_vol'].median(),stats.ks_2samp(l_ltp_m['b_vol'],l_c_m['b_vol']))
